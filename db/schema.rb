...
ActiveRecord::Schema.define(version: 2020_05_17_054533) do
  ...
  create_table "posts_topics", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.bigint "post_id"
    t.bigint "topic_id"
